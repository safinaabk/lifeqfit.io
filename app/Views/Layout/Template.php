...
<body>
    <div style="width:6%;float:left; margin:auto;">
        <nav class="navbar card flex-column shadow  bg-body rounded" style="--bs-card-border-color:none; width: 6%; text-align: center;width:100%;--bs-card-border-radius: 0rem 0.375rem 0.375rem 0rem;height:100%;">
            <!--<img class="mt-4 mb-5 logo" src="<?php echo base_url('assets/images/lifeqfit.jpg');?>" alt="">-->
            <a href="<?= base_url('Cuser/home') ?>"><i class="fa-duotone fa-books-medical fa-2x nav-link mt-4 " style="color:var(--color-one); position:absolute; left:0; right:0;"  ></i></a>
            <div class="d-flex flex-column" style="margin:auto;">
                ...
                <a href="<?= base_url('Cmakanan') ?>"><i class="fa-duotone fa-pot-food fa-2x nav-link mt-5" style="color:var(--color-one);padding-top:30%;padding-bottom:30%;" ></i></a></li>
